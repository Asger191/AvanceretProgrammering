...
public class Dijkstra {
    public static void main(String[] args) {
        WeighedNote S = new WeighedNote("S");
        WeighedNote A = new WeighedNote("A");
        WeighedNote B = new WeighedNote("B");
        WeighedNote C = new WeighedNote("C");
        WeighedNote D = new WeighedNote("D");
        WeighedNote E = new WeighedNote("E");
        WeighedNote F = new WeighedNote("F");
        WeighedNote G = new WeighedNote("G");
        WeighedNote H = new WeighedNote("H");
        WeighedNote I = new WeighedNote("I");
        WeighedNote J = new WeighedNote("J");
        WeighedNote K = new WeighedNote("K");
        WeighedNote L = new WeighedNote("L");
        WeighedNote M = new WeighedNote("M");
    ...
    public static void findShortestPath(WeighedNote source, WeighedNote destination) {
        // En node og den node vi kom fra. Skal bruges til at printe vejen fra start til slut
        Map<WeighedNote, WeighedNote> prev = new HashMap<>();

        // Gemmer den billigste kendte dist til hver node
        Map<WeighedNote, Integer> dist = new HashMap<>();
    ...
    private static class NodeWithDist implements Comparable<NodeWithDist> {
        ...
        public NodeWithDist(WeighedNote node, int dist) {
            this.node = node;
            this.dist = dist;
        }
